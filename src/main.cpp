...
void processInput(GLFWwindow *window, shaderManager &shader)
{
...
int main()
{
    ...
    Shader shader("../resource/vertexgls.gls", "../resource/fragmentgls.gls");
    Shader lightshader("../resource/ligth_v.gls", "../resource/ligthf_fgls.gls");

    unsigned int texture = LoadImage("container2.png");
   ...
   float vertices2[] = {
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        modelobj = glm::translate(modelobj, glm::vec3(0.0, 0.0, 0.0));
